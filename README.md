...
[![Typing SVG](https://readme-typing-svg.herokuapp.com?font=Fira+Code&size=22&duration=3000&pause=1000&color=B18FA2&center=true&vCenter=true&width=600&lines=Full-Stack+TypeScript+Engineer;AI+%2B+RAG+Systems+Builder;Building+Tech+for+African+Markets;Solo+Founder+%40+FinAdvisor+AI)](https://github.com/Susankemigisa)

</div>

## 👋 About Me

I'm a **Software & AI Engineer** based in Kampala, Uganda 🇺🇬 — I build full-stack products end-to-end, from database schema to polished UI, with AI woven in where it actually adds value.

- 🚀 Solo founder of **FinAdvisor AI** — an AI-powered financial advisor for African markets
- 🌍 Passionate about building for African contexts: local languages, mobile money, offline-first
- 🤖 Deep in **LLM integrations & RAG pipelines** across multiple providers
- 🏆 Hackathon builder — led an 8-person team building **MamaCare**, a maternal health AI assistant over USSD/SMS/Voice
...
![OpenAI](https://img.shields.io/badge/LLM_Integrations-412991?style=for-the-badge&logo=openai&logoColor=white)
![RAG](https://img.shields.io/badge/RAG_Pipelines-632148?style=for-the-badge)
...
|---------|-------------|-------|
| 💰 **FinAdvisor AI** | AI-powered financial advisor built for African markets — multi-LLM chat, goal tracking, email notifications | Next.js · LLMs · Zustand |
